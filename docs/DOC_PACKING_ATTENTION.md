...
![Memory Waterfall](figures/exp2_memory_waterfall.png)
...
![稀疏性可视化](figures/exp3_sparsity.png)
...
![显存与速度](figures/exp1_memory_speed.png)
...
![SDPA 基线](figures/exp4_sdpa_baseline.png)
...
![OOM 边界](figures/exp5_oom_boundary.png)
