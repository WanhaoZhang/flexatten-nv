...
| [FlexAttention FLASH/CuteDSL 后端复测](docs/FLEXATTENTION_FLASH_CUTEDSL_BACKEND_REPORT.md) | PyTorch nightly + flash-attn-4 + nvidia-cutlass-dsl 环境；确认 FlexAttention 进入 CuteDSL/CUTLASS 调用链，并解释 L4 sm89 的架构限制 | - |
